    ...
    def find_most_similar_word(self, vector, n=1, exclude=[]):
        ...
        for word in self.embeddings:
            if word not in exclude:
                ...
                similarity = (word, cosine_similarity(vector, embedding))
...
def telepathy_game(player1, player2, player1_word, player2_word, max_iterations=10):
        ...
        while not converged and iteration < max_iterations:
            ...
            similarity = cosine_similarity(player1.get_word_embedding(player1_association), player2.get_word_embedding(player2_association))
            ...
            if similarity > 0.8:  # You can adjust the similarity threshold
                ...
                print("After %i iterations, Player 1's world is %s and Player 2's word is %s", iteration, player1_word, player2_word)

            iteration += 1


if __name__ == '__main__':
    player1_file = '/projects/e31408/data/a5/glove_top50k_50d.txt'
    player2_file = '/projects/e31408/data/a5/glove_top50k_50d.txt'
